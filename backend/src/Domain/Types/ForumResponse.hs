...
$(deriveJSON defaultOptions{fieldLabelModifier = camelTo2 '_' . drop (T.length "obfr")} 'ForumResponse)
$(deriveJSON defaultOptions{fieldLabelModifier = camelTo2 '_' . drop (T.length "fr")} 'ObfuscatedForumResponse)
